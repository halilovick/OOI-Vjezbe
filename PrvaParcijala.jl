...
println("x2 = ", value(x2))
println("x3 = ", value(x3))
println("x4 = ", (40 - value(constraint1)))
println("x5 = ", (30 - value(constraint2)))
println("x6 = ", (100 - value(constraint3)))
println("Vrijednost cilja: ")
println(objective_value(m))
println("y1 = ", dual(constraint1))
println("y2 = ", dual(constraint2))
println("y3 = ", dual(constraint3))
println("y4 = ", -1 * (dual(LowerBoundRef(x1))))
println("y5 = ", -1 * (dual(LowerBoundRef(x2))))
println("y6 = ", -1 * (dual(LowerBoundRef(x3))))